$(window).on('load', function () {
  ...
  $('#nava-icon').click(function (e) {
    ...
    if (document.getElementById('nava').classList.contains('nava-active')) {
      this.innerHTML = '<span class="lnr lnr-cross"></span>';
    }else{
      this.innerHTML = '<span class="lnr lnr-menu"></span>';
    }
